...
export default function DashboardContent() {
  return (
    <div className="p-4 space-y-6">
      {/* Orders Section */}
      <div className="h-80 p-6 bg-rose-100 dark:bg-rose-900/30 rounded-[40px] flex justify-start items-end gap-6 overflow-auto w-[calc(100vw-160px-32px)]">
        {/* Ordens Abertas */}
        <div className="w-64 h-56 p-6 bg-stone-400 dark:bg-stone-600 rounded-3xl flex flex-col justify-center items-start gap-10 flex-shrink-0">
